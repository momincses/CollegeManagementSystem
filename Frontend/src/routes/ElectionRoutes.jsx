...
const NavigationButtons = ({ userRole }) => {
  return (
    <Stack direction="row" spacing={2} sx={{ mb: 3, mt: 2 }}>
      <Button component={Link} to="/election/candidates" variant="contained" color="primary">
        View Candidates
      </Button>
      <Button component={Link} to="/election/vote" variant="contained" color="primary">
        Vote Now
      </Button>
      <Button component={Link} to="/election/results" variant="contained" color="primary">
        View Results
      </Button>
      {userRole === 'admin' && (
        <Button component={Link} to="/election/dashboard" variant="contained" color="secondary">
          Admin Dashboard
        </Button>
      )}
    </Stack>
