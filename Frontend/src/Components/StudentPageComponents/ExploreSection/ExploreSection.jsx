...
const exploreItems = [
  ...
  { label: "Facility Booking", path: "/student/allfacilities" },
  { label: "Event Requests", path: "/student/events" },
  { label: "Complaints", path: "/student/public-complaints" },
  { label: "Budget Tracker", path: "/student/expenditure/list" },
  { label: "Cheater Records", path: "/student/cheaters-records" },
