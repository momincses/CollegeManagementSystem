...
const Navbar = () => {
  ...
  const menuItems = [
    { text: "Dashboard", path: "/board-member" },
    { text: "Flagged Complaints", path: "/board-member/flagged-complaints" },
    { text: "Public Complaints", path: "/board-member/public-complaints" },
    { text: "Logout", path: "/board-member/logout" },
